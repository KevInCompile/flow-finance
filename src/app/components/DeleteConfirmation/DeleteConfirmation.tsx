    ...
    <>
      ...
      {confirmDelete && (
        <div className="fixed top-0 left-0 min-w-full min-h-full backdrop-blur-sm z-10">
          <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-[#242424] text-white p-5 rounded-md w-[80%] md:w-auto border">
            <h3 className="font-medium text-xl text-center text-palette mb-2">
              ¿Estás seguro?
            </h3>
