...
export async function POST(req: Request) {
  ...
  try{
    ...
    const {rows} =  await sql`SELECT I.id, I.value, I.typeincome, I.date, C.name as account, I.AccountId FROM incomes as I INNER JOIN accounts as C ON I.AccountId = C.Id where I.Username = ${username} ORDER BY Id DESC LIMIT 1`
